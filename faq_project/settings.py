...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-ge@dsbx-$9+=g2@k-e#vkkg0ee*oi&cx2n2^syn335!&49im)!')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv('DEBUG', 'True') == 'True'

ALLOWED_HOSTS = ['127.0.0.1', 'faq-project-rwxh.onrender.com', 'localhost']
...
LOGIN_REDIRECT_URL = '/'  # Or wherever you want users to be redirected
